...
export function appContentTemplate(app: ManagedAppView | undefined, page: AppContentPage | null) {
  ...
  return `<section class="dashboard-page app-content-page"><a href="/" class="hint">Bidra / ${h(app.name)}</a><h1>Initiativ</h1><p class="hint">Content-pilot för ${h(app.name)}. Bidras nuvarande katalog använder fortfarande sitt befintliga register.</p>
